...
class NPMUploadTest(PackageBaseTest):
    ...
    def test_dist_gen_in_single_target(self):
        ...
        meta_content_client_7_14_5 = str(
            meta_obj_client_7_14_5.get()["Body"].read(), "utf-8"
        )
        self.assertIn('"dist"', meta_content_client_7_14_5)
        self.assertIn(
            '"tarball": "https://npm1.registry.redhat.com/@babel/code-frame/-/code'
            '-frame-7.14.5.tgz"',
            meta_content_client_7_14_5,
        )
        self.assertIn(
            '"shasum": "23b08d740e83f49c5e59945fbf1b43e80bbf4edb"',
            meta_content_client_7_14_5,
        )
        self.assertIn(
            '"integrity": '
        ...
        merged_meta_content_client = str(
            merged_meta_obj_client.get()["Body"].read(), "utf-8"
        )
    ...
    def test_dist_gen_in_multi_targets(self):
        targets_ = [
            (None, TEST_BUCKET, None, "npm1.registry.redhat.com"),
        ...
        merged_meta_content_client = str(
            merged_meta_obj_client_1.get()["Body"].read(), "utf-8"
        )
        self.assertIn('"dist"', merged_meta_content_client)
        self.assertIn(
            '"tarball": "https://npm1.registry.redhat.com/@babel/code-frame/-/code'
        ...
        self.assertIn('"dist"', meta_content_client_7_14_5)
        self.assertIn(
            '"tarball": "https://npm2.registry.redhat.com/@babel/code-frame/-/code'
            '-frame-7.14.5.tgz"',
            meta_content_client_7_14_5,
        )
        ...
        merged_meta_content_client = str(
            merged_meta_obj_client_2.get()["Body"].read(), "utf-8"
        )
        self.assertIn('"dist"', merged_meta_content_client)
        self.assertIn(
            '"tarball": "https://npm2.registry.redhat.com/@babel/code-frame/-/code'
    ...
    def test_overlapping_registry_dist_gen(self):
        ...
        targets_overlapping_ = [
            (None, TEST_BUCKET, None, "npm1.overlapping.registry.redhat.com")
        ]
        test_tgz = os.path.join(os.getcwd(), "tests/input/code-frame-7.14.5.tgz")
        product_7_14_5 = "code-frame-7.14.5"
        handle_npm_uploading(
        ...
        self.assertIn('"dist"', meta_content_client_7_14_5)
        self.assertIn(
            '"tarball": "https://npm1.overlapping.registry.redhat.com/@babel/code'
            '-frame/-/code-frame-7.14.5.tgz"',
            meta_content_client_7_14_5,
        )
