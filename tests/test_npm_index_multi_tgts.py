...
class NpmFileIndexMultiTgtsTest(PackageBaseTest):
    ...
    def __test_upload_prefix(self, prefix: str = None):
        ...
        for target in targets_:
            ...
            if prefix and prefix != "/":
                ...
                PREFIXED_NAMESPACE_BABEL_INDEX = os.path.join(
                    prefix, NAMESPACE_BABEL_INDEX
                )
    ...
    def test_overlap_upload_index(self):
        ...
        for target in targets_:
            ...
            self.assertIn(NAMESPACE_BABEL_INDEX, actual_files, msg=f"{bucket_name}")
    ...
    def __test_deletion_prefix(self, prefix: str = None):
        ...
        test_tgz = os.path.join(os.getcwd(), "tests/input/code-frame-7.14.5.tgz")
        product_7_14_5 = "code-frame-7.14.5"
        handle_npm_del(test_tgz, product_7_14_5, targets=targets_, dir_=self.tempdir)
        ...
        for target in targets_:
            ...
            self.assertIn(
                PREFIXED_NAMESPACE_BABEL_INDEX, actual_files, msg=f"{bucket_name}"
            )
        ...
        handle_npm_del(test_tgz, product_7_15_8, targets=targets_, dir_=self.tempdir)
    ...
    def __prepare_content(self, prefix: str = None):
        ...
        product_7_14_5 = "code-frame-7.14.5"
        handle_npm_uploading(
            test_tgz, product_7_14_5, targets=targets_, dir_=self.tempdir
        )

        test_tgz = os.path.join(os.getcwd(), "tests/input/code-frame-7.15.8.tgz")
        product_7_15_8 = "code-frame-7.15.8"
        handle_npm_uploading(
            test_tgz, product_7_15_8, targets=targets_, dir_=self.tempdir
        )
