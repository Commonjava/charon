...
class MavenMetadataTest(BaseMRRCTest):
    ...
    def test_parse_ga(self):
        ...
        g, a = mvn.parse_ga('/tmp/maven-repository/org/apache/maven/plugins/maven-plugin-plugin',
    ...
    def test_parse_gavs(self):
        ...
        self.assertEqual(['1.0.0', '1.0.1', '1.2.0'],
    ...
    def test_gen_meta_file(self):
        ...
        os.mkdir(temp_root)
        archive.extract_zip_all(zipfile.ZipFile('tests/input/commons-lang3.zip'), temp_root)
        ...
        versions = list(filter(lambda e: e.firstChild is not None,
